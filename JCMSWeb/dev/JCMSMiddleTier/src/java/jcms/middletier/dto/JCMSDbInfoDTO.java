 ...
 * @author rkavitha
 */
public class JCMSDbInfoDTO extends JCMSDbInfoEntity{
    private static final long serialVersionUID = 1L;

    public JCMSDbInfoDTO (JCMSDbInfoEntity entity)
    {
        if (entity != null) {
    ...
    public JCMSDbInfoEntity getDbInfoEntity()
    {
        JCMSDbInfoEntity entity = new JCMSDbInfoEntity();
