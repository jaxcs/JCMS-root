...
/**
 * <b>File name:</b> CauseOfDeathConverter.java  <p>
 ...
 */
public class CauseOfDeathConverter extends WTBaseConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        CvCauseOfDeathEntity entity = null;
        try {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            if (value != null && (!value.equals(""))) {
                key = (((CvCauseOfDeathEntity) value).getKey()).toString();
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Value");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
     ...
     *      given data type key.
     * Overview:  Converts the unique String representation of CvCauseOfDeath
     *      to the actual object.
     * @param key CauseOfDeath primary key
     * @return CvCauseOfDeathEntity Data Type object
     */
    private CvCauseOfDeathEntity findEntity(String key) {
        CvCauseOfDeathEntity dataTypeObject = null;

        try {
            for (CvCauseOfDeathEntity e : this.getListSupportDTO().getCvCauseOfDeath()) {
                if (key.equalsIgnoreCase(e.getCauseOfDeathkey().toString())) {
                    dataTypeObject = e;
                    break;
                }
            }
