 ...
 * @author rkavitha
 */
public class CrossStatusConverter extends WTBaseConverter implements
        Converter {
    /**
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        CvCrossstatusEntity entity = null;
        try {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            if (value != null && (!value.equals(""))) {
                key = (((CvCrossstatusEntity) value).getKey()).toString();
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Container Status");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
     ...
     */
    private CvCrossstatusEntity findEntity(String key) {
        CvCrossstatusEntity dataTypeObject = null;

        try {
            for (CvCrossstatusEntity e : this.getListSupportDTO().getCvCrossStatus()) {
                if (key.equalsIgnoreCase(e.getCrossStatuskey().toString())) {
                    dataTypeObject = e;
                    break;
                }
            }
