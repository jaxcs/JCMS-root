...
/**
 * <b>File name:</b> LifeStatusConverter.java  <p>
 ...
 */
public class LifeStatusConverter extends WTBaseConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            if (value != null && (!value.equals(""))) {
                key = (((LifeStatusEntity) value).getKey()).toString();
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Value");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
     ...
     *      given data type key.
     * Overview:  Converts the unique String representation of LifeStatusEntity
     *      to the actual object.
     * @param key LifeStatusEntity primary key
     * @return LifeStatusEntity Data Type object
     */
    private LifeStatusEntity findEntity(String key) {
        LifeStatusEntity dataTypeObject = null;

        try {
            for (LifeStatusEntity e : this.getListSupportDTO().getLifeStatus()) {
                if (key.equalsIgnoreCase(e.getLifeStatuskey().toString())) {
                    dataTypeObject = e;
                    break;
                }
            }
