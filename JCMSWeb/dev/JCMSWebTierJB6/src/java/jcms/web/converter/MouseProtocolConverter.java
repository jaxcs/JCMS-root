...
/**
 * <b>File name:</b> MouseProtocolConverter.java  <p>
 ...
 */
public class MouseProtocolConverter extends WTBaseConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        CvMouseProtocolEntity entity = null;
        try {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            if (value != null && (!value.equals(""))) {
                key = (((CvMouseProtocolEntity) value).getKey()).toString();
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Value");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
     ...
     *      given data type key.
     * Overview:  Converts the unique String representation of CvMouseProtocolEntity
     *      to the actual object.
     * @param key CvMouseProtocolEntity primary key
     * @return CvMouseProtocolEntity object
     */
    private CvMouseProtocolEntity findEntity(String key) {
        CvMouseProtocolEntity dataTypeObject = null;

        try {
            for (CvMouseProtocolEntity e : this.getListSupportDTO().getAllCvMouseProtocol()) {
                if (key.equalsIgnoreCase(e.getMouseProtocolkey().toString())) {
                    dataTypeObject = e;
                    break;
                }
            }
