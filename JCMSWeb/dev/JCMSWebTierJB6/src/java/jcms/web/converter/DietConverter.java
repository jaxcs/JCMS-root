 ...
 * @author rkavitha
 */
public class DietConverter extends WTBaseConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        CvDietEntity entity = null;
        try {
            if (value != null && (!value.equals(""))) {
                entity = findEntity(value);
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Diet");
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            if (value != null && (!value.equals(""))) {
                key = (((CvDietEntity) value).getKey()).toString();
            }
        } catch (Exception e) {
     ...
     */
    private CvDietEntity findEntity(String key) {
        CvDietEntity dataTypeObject = null;

        try {
            for (CvDietEntity e : this.getListSupportDTO().getCvDiet()) {
                if (key.equalsIgnoreCase(e.getDietKey().toString())) {
                    dataTypeObject = e;
                    break;
                }
            }
