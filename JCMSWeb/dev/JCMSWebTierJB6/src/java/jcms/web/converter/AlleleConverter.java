...
/**
 * <b>File name:</b> AlleleConverter.java  <p>
 ...
 */
public class AlleleConverter extends WTBaseConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
        AlleleEntity entity = null;
        try {
            if (newValue == null) {
                return new AlleleEntity().getBlankAlleleEntity();
            } else 
            if (newValue.equals("")) {
                entity = new AlleleEntity().getBlankAlleleEntity();
            } else {
                entity = findEntity(newValue);
            }
        } catch (Exception e) {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            if (value == null) {
                ...
                displayValue = (((AlleleEntity) value).getAlleleKey()).toString();
            }
        } catch (Exception e) {
            FacesMessage message = new FacesMessage();
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
