...
/**
 * <b>File name:</b> MouseOriginConverter.java  <p>
 ...
 */
public class MouseOriginConverter extends WTBaseConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        CvMouseOriginEntity entity = null;
        try {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            if (value != null && (!value.equals(""))) {
                key = (((CvMouseOriginEntity) value).getKey()).toString();
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Value");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
     ...
     *      given data type key.
     * Overview:  Converts the unique String representation of CvMouseOriginEntity
     *      to the actual object.
     * @param key CvMouseOriginEntity primary key
     * @return CvMouseOriginEntity Data Type object
     */
    private CvMouseOriginEntity findEntity(String key) {
        CvMouseOriginEntity dataTypeObject = null;

        try {
            for (CvMouseOriginEntity e : this.getListSupportDTO().getCvMouseOrigin()) {
                if (key.equalsIgnoreCase(e.getMouseOriginkey().toString())) {
                    dataTypeObject = e;
                    break;
                }
            }
