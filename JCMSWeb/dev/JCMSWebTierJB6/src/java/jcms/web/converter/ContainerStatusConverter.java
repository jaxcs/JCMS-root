 ...
 * @author rkavitha
 */
public class ContainerStatusConverter extends WTBaseConverter implements
        Converter {
    /**
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        CvContainerStatusEntity entity = null;
        try {
            if (value != null && (!value.equals(""))) {
                entity = findEntity(value);
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Container Status");
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            if (value != null && (!value.equals(""))) {
                key = (((CvContainerStatusEntity) value).getKey()).toString();
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Container Status");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
     ...
     */
    private CvContainerStatusEntity findEntity(String key) {
        CvContainerStatusEntity dataTypeObject = null;

        try {
            for (CvContainerStatusEntity e : this.getListSupportDTO().getCvContainerStatus()) {
                if (key.equalsIgnoreCase(e.getContainerStatuskey().toString())) {
                    dataTypeObject = e;
                    break;
                }
            }
