...
/**
 * <b>File name:</b> LitterNumbersConverter.java  <p>
 ...
 */
public class LitterNumbersConverter extends WTBaseConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        try {
            if (value != null && (!value.equals(""))) {
                key = (((LitterEntity) value).getKey()).toString();
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Value");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
     ...
     *      given data type key.
     * Overview:  Converts the unique String representation of LitterEntity
     *      to the actual object.
     * @param key LitterEntity primary key
     * @return LitterEntity object
     */
    private LitterEntity findEntity(String key) {
        LitterEntity dataTypeObject = null;

        try {
            for (LitterEntity e : this.getListSupportDTO().getAllLitterIDs()) {
                if (key.equalsIgnoreCase(e.getLitterKey().toString())) {
                    dataTypeObject = e;
                    break;
                }
            }
