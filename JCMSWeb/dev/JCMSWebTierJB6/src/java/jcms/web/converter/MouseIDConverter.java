...
/**
 * <b>File name:</b> MouseIDConverter.java  <p>
 ...
 */
public class MouseIDConverter extends WTBaseConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        MouseEntity entity = null;
        try {
            if (value != null && (!value.equals(""))) {
                entity = findEntity(value);
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Mouse ID");
    ...
    public String getAsString(FacesContext context, UIComponent component,
        ...
        try {
            if (value != null && (!value.equals(""))) {
                key = (((MouseEntity) value).getKey()).toString();
            }
        } catch (Exception e) {
            FacesMessage message = this.getMessage(context, "Invalid Mouse ID");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
     ...
     *      given data type key.
     * Overview:  Converts the unique String representation of MouseEntity
     *      to the actual object.
     * @param key MouseEntity primary key
     * @return MouseEntity Data Type object
     */
    private MouseEntity findEntity(String key) {
        MouseEntity dataTypeObject = null;

        try {
            for (MouseEntity e : this.getListSupportDTO().getAllMouseIDs()) {
                if (key.equalsIgnoreCase(e.getMouseKey().toString())) {
                    dataTypeObject = e;
                    break;
                }
            }
