 ...
 * @author mkamato
 */
public class WeanQueueBuilder {
    
    //TO BE TREATED AS QUEUE!! ALWAYS USE poll() TO GET VALUES FROM LL
    ...
    private LinkedList<String> tagDateQueue = new LinkedList<String>();
    private LinkedList<String> commentQueue = new LinkedList<String>();
    private LinkedList<String> totalBornQueue = new LinkedList<String>();
    private LinkedList<String> litterBirthDateQueue = new LinkedList<String>();
    private LinkedList<String> statusQueue = new LinkedList<String>();
    private LinkedList<String> dam1GenotypeQueue = new LinkedList<String>();
    private LinkedList<String> dam2GenotypeQueue = new LinkedList<String>();
    private LinkedList<String> sireGenotypeQueue = new LinkedList<String>();
    ...
    private LinkedList<String> sireIDQueue = new LinkedList<String>();
    private LinkedList<String> dam1IDQueue = new LinkedList<String>();
    private LinkedList<String> dam2IDQueue = new LinkedList<String>();
    private LinkedList<String> sireStrainQueue = new LinkedList<String>();
    private LinkedList<String> dam1StrainQueue = new LinkedList<String>();
    private LinkedList<String> dam2StrainQueue = new LinkedList<String>();
    ...
    public WeanQueueBuilder(SortedMap[] theResults, SortedMap[] theDbSetupResults, ArrayList<String> theWgList){
        results = theResults;
        wgList = theWgList;
        if(results.length == 0){
            containerID="";
            containerName="";
            MTSValue="false";
            if(theDbSetupResults.length > 0){
                PIPhone = myGet(theDbSetupResults[0], "PIPhone");
                PIName = myGet(theDbSetupResults[0], "PIName");
            }
        }
        else{
    ...
    public boolean genotypeContains(String newGenotype, String currentGenotype){
        if(currentGenotype.contains(newGenotype)){
            return false;
        }
        else{
            return true;
            ...
            if (printExitedMice(mouse)) {
                if (myContains(wgList, myGet(mouse, "owner"))) {
                    if (getIDQueue().contains(mouse.get("ID").toString())) {
                        if (genotypeContains(myGet(mouse,"gene"),getGenotypeQueue().peekLast())) {
                            getGenotypeQueue().add(getGenotypeQueue().pollLast() + ", " + mouse.get("gene"));
                        }
                        if (genotypeContains(myGet(mouse,"sireGene"),getSireGenotypeQueue().peekLast())) {
                            getSireGenotypeQueue().add(getSireGenotypeQueue().pollLast() + ", " + mouse.get("sireGene"));
                        }
                        if (genotypeContains(myGet(mouse,"dam1Gene"),getDam1GenotypeQueue().peekLast())) {
                            getDam1GenotypeQueue().add(getDam1GenotypeQueue().pollLast() + ", " + mouse.get("dam1Gene"));
                        }
                        if (genotypeContains(myGet(mouse,"dam2Gene"),getDam2GenotypeQueue().peekLast())) {
                            getDam2GenotypeQueue().add(getDam2GenotypeQueue().pollLast() + ", " + mouse.get("dam2Gene"));
                        }
                    } 
                    else {
                        add(getIDQueue(), mouse.get("ID"));
                        add(getLitterIDQueue(), mouse.get("litterID"));
                        add(getNumFemaleQueue(), mouse.get("numFemale"));
                        add(getNumMaleQueue(), mouse.get("numMale"));
                        add(getBirthDateQueue(), mouse.get("birthDate"));
                        add(getWeanDateQueue(), mouse.get("weanDate"));
                        add(getTagDateQueue(), mouse.get("tagDate"));
                        add(getTotalBornQueue(), mouse.get("totalBorn"));
                        ...
                        add(getLitterBirthDateQueue(), mouse.get("litterBirthDate"));
                        add(getStatusQueue(), mouse.get("status"));
                        add(getDam1GenotypeQueue(), mouse.get("dam1Gene"));
                        add(getDam2GenotypeQueue(), mouse.get("dam2Gene"));
                        add(getSireGenotypeQueue(), mouse.get("sireGene"));
                        add(getSireIDQueue(), mouse.get("sireID"));
                        add(getDam1IDQueue(), mouse.get("dam1ID"));
                        add(getDam2IDQueue(), mouse.get("dam2ID"));
                        add(getSireStrainQueue(), mouse.get("sireStrain"));
                        add(getDam1StrainQueue(), mouse.get("dam1Strain"));
                        add(getDam2StrainQueue(), mouse.get("dam2Strain"));
    ...
    public void add(Queue theQueue, Object obj){
        if(obj!=null){
    ...
    /**
     * @return the tagDateQueue
     */
    public LinkedList<String> getTagDateQueue() {
        return tagDateQueue;
    }

    /**
     * @param tagDateQueue the tagDateQueue to set
     */
    public void setTagDateQueue(LinkedList<String> tagDateQueue) {
        this.tagDateQueue = tagDateQueue;
    }
    ...
    /**
     * @return the totalBornQueue
     */
    public LinkedList<String> getTotalBornQueue() {
        return totalBornQueue;
    }

    /**
     * @param totalBornQueue the totalBornQueue to set
     */
    public void setTotalBornQueue(LinkedList<String> totalBornQueue) {
        this.totalBornQueue = totalBornQueue;
    }
    ...
    /**
     * @return the statusQueue
     */
    public LinkedList<String> getStatusQueue() {
        return statusQueue;
    }

    /**
     * @param statusQueue the statusQueue to set
     */
    public void setStatusQueue(LinkedList<String> statusQueue) {
    ...
    /**
     * @return the dam1GenotypeQueue
     */
    public LinkedList<String> getDam1GenotypeQueue() {
        return dam1GenotypeQueue;
    }

    /**
     * @return the dam2GenotypeQueue
     */
    public LinkedList<String> getDam2GenotypeQueue() {
        return dam2GenotypeQueue;
    }

    /**
     * @return the sireGenotypeQueue
     */
    public LinkedList<String> getSireGenotypeQueue() {
        return sireGenotypeQueue;
    }
    ...
    /**
     * @return the sireIDQueue
     */
    public LinkedList<String> getSireIDQueue() {
        return sireIDQueue;
    }

    /**
     * @param sireIDQueue the sireIDQueue to set
     */
    public void setSireIDQueue(LinkedList<String> sireIDQueue) {
        this.sireIDQueue = sireIDQueue;
    }

    /**
     * @return the dam1IDQueue
     */
    public LinkedList<String> getDam1IDQueue() {
        return dam1IDQueue;
    }

    /**
     * @param dam1IDQueue the dam1IDQueue to set
     */
    public void setDam1IDQueue(LinkedList<String> dam1IDQueue) {
        this.dam1IDQueue = dam1IDQueue;
    }

    /**
     * @return the dam2IDQueue
     */
    public LinkedList<String> getDam2IDQueue() {
        return dam2IDQueue;
    }

    /**
     * @param dam2IDQueue the dam2IDQueue to set
     */
    public void setDam2IDQueue(LinkedList<String> dam2IDQueue) {
        this.dam2IDQueue = dam2IDQueue;
    }

    /**
     * @return the sireStrainQueue
     */
    public LinkedList<String> getSireStrainQueue() {
        return sireStrainQueue;
    }

    /**
     * @param sireStrainQueue the sireStrainQueue to set
     */
    public void setSireStrainQueue(LinkedList<String> sireStrainQueue) {
        this.sireStrainQueue = sireStrainQueue;
    }

    /**
     * @return the dam1StrainQueue
     */
    public LinkedList<String> getDam1StrainQueue() {
        return dam1StrainQueue;
    }

    /**
     * @param dam1StrainQueue the dam1StrainQueue to set
     */
    public void setDam1StrainQueue(LinkedList<String> dam1StrainQueue) {
        this.dam1StrainQueue = dam1StrainQueue;
    }

    /**
     * @return the dam2StrainQueue
     */
    public LinkedList<String> getDam2StrainQueue() {
        return dam2StrainQueue;
    }

    /**
     * @param dam2StrainQueue the dam2StrainQueue to set
     */
    public void setDam2StrainQueue(LinkedList<String> dam2StrainQueue) {
        this.dam2StrainQueue = dam2StrainQueue;
    }
