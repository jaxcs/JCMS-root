 ...
 * @author mkamato
 */
public class CustomLandscapeMatingCardGenerator extends MatingCardTemplate{
    ...
    public byte[] buildCard(CageCardResultDTO CCRDTO, HttpServletResponse HSR, String ContainerID){
        try {
            ...
            theBuilder = new MatingQueueBuilder(MCRDTO.getMatingResult().getRows(), CCRDTO.getDbSetupResults().getRows(), CCRDTO.getMyWorkgroups());
