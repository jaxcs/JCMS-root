 ...
 * @author mkamato
 */
public class CustomLandscapeWeanCardGenerator extends WeanCardTemplate{
    ...
    public byte[] buildCard(CageCardResultDTO CCRDTO, HttpServletResponse HSR, String ContainerID){
        try {
            ...
            theBuilder = new WeanQueueBuilder(CCRDTO.getResult().getRows(), CCRDTO.getDbSetupResults().getRows(), CCRDTO.getMyWorkgroups());
