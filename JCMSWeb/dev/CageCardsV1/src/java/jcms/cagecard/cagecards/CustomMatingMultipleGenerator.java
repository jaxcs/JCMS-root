 ...
 * @author mkamato
 */
public class CustomMatingMultipleGenerator extends MatingCardTemplate{
        ...
        try {
            ...
            for (Result mr : MCRDTO.getMatingResults()) {
                if (MCRDTO.getGoodCards().contains(containerID)) {
                    ...
                    theBuilder = new MatingQueueBuilder(mr.getRows(), CCRDTO.getDbSetupResults().getRows(), MCRDTO.getMyWorkgroups());
