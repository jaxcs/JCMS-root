...
rem $Id: twiddle.bat 99078 2010-01-06 22:18:01Z acoliver@jboss.org $
...
set JBOSS_CLASSPATH=%JBOSS_CLASSPATH%;%DIRNAME%\..\client\jboss-common.jar
set JBOSS_CLASSPATH=%JBOSS_CLASSPATH%;%DIRNAME%\..\client\jbosssx-client.jar
